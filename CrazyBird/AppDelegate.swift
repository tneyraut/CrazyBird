...
class AppDelegate: UIResponder, UIApplicationDelegate, AVAudioPlayerDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        let music = NSBundle.mainBundle().pathForResource("MusicUp", ofType:"m4a")
        do {
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.ThomasNeyraut.iOS.CrazyBird" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("CrazyBird", withExtension: "momd")!
